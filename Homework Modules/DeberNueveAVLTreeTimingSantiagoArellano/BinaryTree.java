 ...
 * @Description: El presente archivo contiene la implementacin general de un arbol binario con capacidad de expansion para
 * arbol n-ary y threaded. Presenta metoodos de transversacion, conteo de nodos, busqueda, insercion, eliminacion y
 * balanceo interno.
 * @param <E>: Tipo de dato generico que sera utilizado en el arbol binario
 */
