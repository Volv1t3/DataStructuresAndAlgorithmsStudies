...
public interface MyList<E> extends Collection<E> {
  ...
  public void addElementAtIndex(int index, E e);
  ...
  public E setElementAtIndex(int index, E e);
  
  @Override /** Add a new element at the end of this list */
  public default boolean add(E e) {
    addElementAtIndex(size(), e);
    return true;
  }
  ...
  public default boolean remove(Object e) {
    if (indexOfElement(e) >= 0) {
      remove(indexOfElement(e));
      return true;
    }
    else
      return false;
